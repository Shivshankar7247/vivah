<%-- 
    Document   : viewall
    Created on : 23 Oct, 2022, 9:25:44 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        ResultSet x=stmt.executeQuery("select *from vivah where email='"+emailid+"'");
         ...
         <center>
           <table border="2" id="information">
               ...
               <tr><td>Profile for</td><td><input type="text" value="<%=x.getString(2)%>" required></td></tr>
                ...
                <tr><td>DOB</td><td><input type="text" value="<%=x.getString(7)%>" required></td></tr>
