<%-- 
    ...
    Created on : 25 Oct, 2022, 6:53:12 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="searchbydistrict2.css">
    </head>
    <body>
        <div class="box">
       <form action="validation.jsp">
        ...
        <%
        String district=request.getParameter("n1");
        ...
        String sql="select *from vivah where DISTRICT='"+district+"' and gender='"+gender+"' ";
